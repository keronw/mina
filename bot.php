		...
		if($update != null){
          ...
          $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendMessage([
                  'chat_id'=>$chatId,
                  'text'=>"• اهلن بك في اداة مطلوب 🔥 لصيد متاحات انستقرام بكل السهوله 😎🤘
~ @F_7_U  🍂",
                  ...
                  'reply_markup'=>json_encode([
                         'keyboard'=>[
                          ...
                          [['text'=>'- طرق الصيد ⚙']],
                          [['text'=>'- مطور البوت 👨🏻‍💻']],
                          [['text'=>'️- ما هوا بوت صيد والمتاحات ⁉️']],
                          [['text'=>'️- فيديو تخطي حظر وهمي الانستقرام ⚠️']]
                      ]
                  ])
              ]);   
            } if($text == '- English 🔠'){ 
		       ...
		       'chat_id'=>$chatId,
                ...
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'HUNTER 🧑🏻‍💻','url'=>'t.me/F_7_U '],['text'=>'𝐌𝐘 𝐁𝐎𝐓𝐒 🔊','url'=>'@PR2_NET']]
                      ]
                  ])
               ]);
           } if($text == '- عربي 👁'){
		       ...
		       'chat_id'=>$chatId,
                ...
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'مطور البوت 👨🏻‍💻','url'=>'t.me/F_7_U '],['text'=>'قناة البوت 🔊','url'=>'t.me/PR2_NET']]
                      ]
                  ])
               ]);
...
𝐓𝐞𝐥𝐞 : @F_7_U  |",
           ...
           } if($text == '️- ما هوا بوت صيد والمتاحات ⁉️'){ 
            $bot->sendMessage([
         'chat_id'=>$chatId,
                'message_id'=>$mid,
...
طريقة عمل بوت الصيد هيه انك تقوم بجمع يوزرات من الانستقرام ووضعها بالبوت ويقوم بالتخمين على المتابعين او الذين يقوم بمتابعتهم حسب اختيار بالطبع هناك طرق اخرى للسحب عبر هاشتاق متلا او كلمات بالبحث",
           ...
           } if($text == '️- فيديو تخطي حظر وهمي الانستقرام ⚠️'){
                  $bot->sendvideo([ 
          	...
          	if($config['mode'] != null){
                  ...
                  'reply_markup'=>json_encode([
				    ...
				    $bot->sendvideo([
       'chat_id'=>$chatId,
       'video'=> "https://t.me/F_7_U ",
        'caption'=>'👨🏻‍💻- مرحبا عزيزي البوت مدفوع وليس مجاني
- لطلب تفعيل بوت صيد او ملفات يرجا مراسلة المطور 👇',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/F_7_U ']],
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/PR2_NET"]]
                  ]
							])
					]);
				}
